import{o as u}from"./assets/footer-a398678f.js";import{a as l}from"./assets/vendor-b619ac7a.js";const c=document.querySelector(".top-books-container"),m="https://books-backend.p.goit.global/";p();i();async function h(){try{return await l.get(m+"books/top-books")}catch(t){return alert("Something went wrong, please try again."),t}}async function k(t){try{return await l.get(m+`books/category?category=${t}`)}catch(e){return alertError("Something went wrong, please try again."),e}}async function p(){c.replaceChildren(),c.insertAdjacentHTML("afterbegin",`  <h1 class="best-sellers-title">
    Best sellers <span class="best-sellers-title-accent">Books</span>
  </h1>
  <ul class="top-books-list"></ul>`);const t=document.querySelector(".top-books-list");(await h()).data.map(s=>{const n=f(s);t.insertAdjacentHTML("beforeend",n)}),i(),document.querySelectorAll(".top-books-btn").forEach(s=>s.addEventListener("click",L))}function d(t,e){return e.length>t?e.slice(0,t)+"...":e}function f(t){const e=t.books.map(o=>y(o)).join("");return`
