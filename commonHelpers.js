import{o as u}from"./assets/footer-154b2a0e.js";import{a as l}from"./assets/vendor-b619ac7a.js";const c=document.querySelector(".top-books-container"),m="https://books-backend.p.goit.global/";p();i();async function k(){try{return await l.get(m+"books/top-books")}catch(t){return alert("Something went wrong, please try again."),t}}async function h(t){try{return await l.get(m+`books/category?category=${t}`)}catch(e){return alertError("Something went wrong, please try again."),e}}async function p(){c.replaceChildren(),c.insertAdjacentHTML("afterbegin",`  <h1 class="best-sellers-title">
